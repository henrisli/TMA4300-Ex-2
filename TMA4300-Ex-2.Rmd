...
# Fit a Bayesian model using the inla() function
res <- inla(formula,family="poisson", E = Oral$E, data=Oral)

# Look at results
summary(res)
# Look at the estimated marginal posterior distributions
plot(res$marginals.fixed$`(Intercept)`)
hist(kappau)
```
