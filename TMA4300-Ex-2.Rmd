...
```
$p$-values of `r p_val1`, `r pval_2` and `r p_val3` indicate that the chain converges during the first $10\%$ iterations for all three components in consideration.
...
```
For the three components of $\mathbf{v}$ in figure \ref{fig:comp3eta} we see that the improved INLA coincides with the original INLA. Also, the marginal densities from INLA perfectly coincides with the histograms of the MCMC samples.
