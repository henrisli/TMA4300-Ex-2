...
We observed that the inclusion of smoking in the model produces a reduction in loglikelihood that outweighs the parameter penalty. However, we see that the reduction is very small. Equivalently we see that the credible interval of the random-walk smoking parameter does not contain the zero-hypothesis for all values of `smoking`, but the interval is very large. Both of these results indicate that the inclusion of smoking in the model yields only a slightly better model. From this we can argue either of the following 
